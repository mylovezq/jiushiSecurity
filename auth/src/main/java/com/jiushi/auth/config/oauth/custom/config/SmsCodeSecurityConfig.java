...
import com.jiushi.auth.config.oauth.custom.provider.SmsCodeAuthenticationProvider;
...
public class SmsCodeSecurityConfig extends
  ...
  /**
   * 短信验证码配置器 所有的配置都可以移步到WebSecurityConfig builder.authenticationProvider() 相当于
